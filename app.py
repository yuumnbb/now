...
2. 具体的な提案
Q1の現状が起きる原因と解決案をを2案提示してください。
「{goal}」の専門性を意識し、アンカーや小さな行動や学習記録をもとに具体的にお願いします。
600文字程度でお願い
...
Atomic Habitsはきっかけ，欲求，反応，報酬のサイクルでポイントとしては，小さく行動していくこと，回数を増やしていくこと．
...
最後に自尊心と自己効力感を高めるためのエールを送りやる気を高めて
"""
    model = genai.GenerativeModel("gemini-2.5-flash-preview-09-2025")
    response = model.generate_content(prompt)
    return response.text.strip()
